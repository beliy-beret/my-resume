      ...
      <h1 className={style.title}>Front-end developer</h1>
        <div className={style.description}>
          <p>
                ...
                Axios. Для единообразия кода подключаю Eslint и Prettier. Прошёл курс перепрофилирования в университете Иннополис, получил диплом о квалификации младший Front-end
