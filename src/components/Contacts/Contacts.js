...
const Contacts = () => {
  return(
    <section className={style.contacts}>
      <div>
        <h2 className={style.title}>Вы можете написать мне здесь</h2>
        <ul className={style.contactList}>
          ...
          <li>Git Hub: <a href="https://github.com/beliy-beret" target="_blank" rel="noreferrer">Skorobogatov Stanislav</a></li>
      ...
      <div>
        <h2 className={style.title}>или заполнив форму</h2>
        <MailForm />
      </div>
    </section>
  );
